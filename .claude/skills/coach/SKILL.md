...
**Signature questions:**
- "You and [partner] haven't had [ritual] in [N] weeks. Is that a time problem or an energy problem?"
...
- "The financial conversation with [partner] keeps getting deferred. What's the version of that conversation that feels safe to start?"
...
- "Your a health marker is a concern but no action in [N] months. What's one appointment you could book this week?"
...
4. Propose a single action that serves multiple goals (e.g., "What if the outdoor session with [partner] counted for Inner Life, Marriage, and Physical Health?").
