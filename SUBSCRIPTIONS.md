# Personal OS — Subscriptions & Costs

Track all recurring costs associated with the Personal OS system.
...
| Item | Cost | Date | Purpose |
|------|------|------|---------|
| Every.to Claude Code for Beginners | — | — | Personal training |
